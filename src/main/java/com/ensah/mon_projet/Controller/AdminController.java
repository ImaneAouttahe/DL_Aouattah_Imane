package com.ensah.mon_projet.Controller;

import com.ensah.mon_projet.entity.*;
import com.ensah.mon_projet.repository.*;
import com.ensah.mon_projet.service.AnnotateurService;
import com.ensah.mon_projet.service.IDatasetService;
import com.ensah.mon_projet.service.UtilisateurService;
    ...
    public String supprimerAnnotateurDataset(
        ...
        redirectAttributes.addFlashAttribute("success",
                String.format("Annotateur supprimé du dataset. %d tâche(s) traitée(s), %d réaffectée(s), %d désaffectée(s).",
                        nbTachesTraitées, nbReaffectees, nbDesaffectees));
