...
--
-- Hôte : 127.0.0.1:3308
-- Généré le : sam. 24 mai 2025 à 10:48
...
CREATE TABLE `annotation` (
  `Id` int(11) NOT NULL,
  `classe_choisie_Id` int(11) DEFAULT NULL,
  `couple_texte_Id` int(11) DEFAULT NULL,
  `annotateur_Id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3721, 'Le chat dort sur le canapé.', 'Un chat est en train de faire la sieste sur le sofa.', 30),
(3722, 'Il pleut aujourd\'hui.', 'Le soleil brille dans le ciel.', 30),
(3723, 'Marie aime le chocolat noir.', 'Marie déteste le chocolat noir.', 30),
...
(50, '2025-06-23 00:00:00.000000', 30, NULL),
(51, '2025-06-24 00:00:00.000000', 31, NULL),
(52, '2025-06-24 00:00:00.000000', 31, 43),
(53, '2025-06-24 00:00:00.000000', 31, 43);
...
CREATE TABLE `tache_couple_texte` (
  ...
  `couple_texte_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(30, 'Boudaa', 'Tarik', 'admin', '$2a$10$F94qOmbEHYrX0mr2ZelzKup7NwukjU0S1yj5JcSg3Ros1knvvEsxe', 1, b'1'),
(42, 'karim', 'ahdad', 'karim', '$2a$10$HfikMTwao1GX.512s4HIIuGl7NVEZNZ9rq1hUteZJAnvSDby.lSkq', 2, b'1'),
(43, 'salmaa', 'afellay', 'salma', '$2a$10$ajDTVVlGNxO89ctqQ/r8TuMoyqDoSP6hwyLC.YJKaGNxOJaXGGG..', 2, b'1'),
(44, 'imane', 'aouattah', 'imane', '$2a$10$1WIhYCEWBQ9xZEQDaK9mEOlX0yeDjksOs.EV.g7qD5s5zTGD/eAD2', 2, b'1'),
(45, 'sara', 'el', 'sara', '$2a$10$u5RhDc7abTZRFl6mt.Nxdudgr0wYSZkz5bKmrz2Wx1QdBdoS1AN9a', 2, b'0'),
(48, 'A', 'A', 'A', '$2a$10$FtM/StwrSWrNKkesuiA2oO/kgF.v53tsvCeUrBzFNc7YDDvzol6ge', 2, b'0');
